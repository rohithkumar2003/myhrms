...
public class Employee {
    ...
    @JoinColumn(name = "user_id") // This will create a foreign key in employees table
 ...
 // In Employee.java, add this field and methods:
    ...
    private void updateTotalWorkedDays() {
        ...
        System.out.println("🔄 Auto-calculated totalWorkedDays: " + this.totalWorkedDays + " = " + worked + " + " + incentive);
    }
    ...
    public static class EmployeeBuilder {
        ...
        public EmployeeBuilder emergencyContactRelation(String emergencyContactRelation) {
        ...
        public Employee build() {
            ...
            employee.emergencyContactName = this.emergencyContactName;
            employee.emergencyContactPhone = this.emergencyContactPhone;
            employee.emergencyContactRelation = this.emergencyContactRelation;
